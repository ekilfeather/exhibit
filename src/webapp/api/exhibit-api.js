...
(function() {
	...
	window.Exhibit = window.Exhibit || {};
        ...
        if (useLocalResources) {
            Exhibit.urlPrefix = "http://exhibit.dmc.dit.ie/exhibit/api/";
        }
         ...
         *
         */  
        /*  This localisation scripts fetcher is disabled as it causesannoying 404 for the non-existant en-US locale. Replaced by hardcoded "en" locale
        for (var i = 0; i < Exhibit.locales.length; i++) {
            scriptURLs.push(Exhibit.urlPrefix + "locales/" + Exhibit.locales[i] + "/locale.js");
        };
        */
        scriptURLs.push(Exhibit.urlPrefix + "locales/" + "en" + "/locale.js");
        scriptURLs.push(Exhibit.urlPrefix + "extensions/time/time-extension.js?bundle=false");
    ...
    if (typeof SimileAjax == "undefined" && !isCompiled) {
        ...
        var url = useLocalResources ?
            "http://exhibit.dmc.dit.ie/ajax/api/simile-ajax-api.js?bundle=false" :
